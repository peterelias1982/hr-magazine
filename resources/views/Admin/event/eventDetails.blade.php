                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 d-flex flex-column justify-content-around">
                      ...
                      <div class="row py-1">
                        ...
                        <p class="card-text lh-1">
                          <input name="address" form="edit-event" class="w-100 border-0 text-black" value="{{$event->streetNo}} {{$event->streetName}}, {{$event->city}}, {{$event->state}}, 
                          {{$event->country}}" disabled="">
                        </p>
                      </div>
                      <div class="row py-1">
...
<td><input type="time" class="form-control" name="fromTime[0]" value="{{ $agenda->fromTime[0] }}"></td>
<td><input type="time" class="form-control" name="toTime[0]" value="{{ $agenda->toTime[0] }}"></td>
<td><input type="text" class="form-control" name="speaker[0]" placeholder="Speaker" value="{{ $agenda->speaker[0] }}"></td>
<td>
