                    ...
                    <div class="col-12 d-flex flex-column">
                        <div class="row flex-grow">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-8 d-flex flex-column">
                                                ...
                                                <div class="row py-1">
                                                    ...
                                                    <p class="card-text lh-1">
                                                        <input name="streetNo" form="edit-event"
                                                               class="w-100 border-0 text-black"
                                                               value="{{$event->streetNo}}" disabled="">
                                                        @error('streetNo')
                                                        {{$message}}
                                                        @enderror
                                                    </p>
                                                    <div class="row py-1">
                                                        ...
                                                        <p class="card-text lh-1">
                                                            <input name="streetName" form="edit-event"
                                                                   class="w-100 border-0 text-black"
                                                                   value="{{$event->streetName}}" disabled="">
                                                            @error('streetName')
                                                            {{$message}}
                                                            @enderror
                                                        </p>
                                                    ...
                                                    <div class="row py-1">
                                                        ...
                                                        <p class="card-text lh-1">
                                                            <input name="city" form="edit-event"
                                                                   class="w-100 border-0 text-black"
                                                        ...
                                                        <div class="row py-1">
                                                            ...
                                                            <p class="card-text lh-1">
                                                                <input name="state" form="edit-event"
                                                                       class="w-100 border-0 text-black"
                                                            ...
                                                            <div class="row py-1">
                                                                ...
                                                                <p class="card-text lh-1">
                                                                    <input name="postalCode" form="edit-event"
                                                                           class="w-100 border-0 text-black"
                                                                           value="{{$event->postalCode}}" disabled="">
                                                                    @error('postalCode')
                                                                    {{$message}}
                                                                    @enderror
                                                                </p>
                                                                <div class="row py-1">
                                                                    ...
                                                                    <p class="card-text lh-1">
                                                                        <input name="country" form="edit-event"
                                                                               class="w-100 border-0 text-black"
                                                                               value="{{$event->country}}" disabled="">
                                                                        @error('country')
                                                                        {{$message}}
                                                                        @enderror
                                                                    </p>
                          ...
                          <textarea name="description" form="edit-event"
                                    class="w-100 p-0 pe-5 border-0 bg-transparent text-black" style="height: 20rem"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="leaflet-pane leaflet-map-pane"
                                                            ...
                                                            <div class="leaflet-proxy leaflet-zoom-animated"
                                                                 style="transform: translate3d(1230540px, 864935px, 0px) scale(4096);"></div>
                                                        </div>
                                                        <div class="leaflet-control-container">
                                                            <div class="leaflet-top leaflet-left">
                                                                <div
                                                                    ...
                                                                    <a
                                                                        class="leaflet-control-zoom-in" href="#"
                                                                        title="Zoom in"
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div
                                                            ...
                                                            <input type="text" id="searchInput" placeholder="e.g. cairo"
                                                                   class="form-control w-75 d-inline-block border-0"
                                                                   disabled="">
                                                            <button id="searchButton"
                                                                    class="btn btn-dark py-1 px-3 btn-sm">
                                                                Search
                                                            </button>
                                                        </div>
