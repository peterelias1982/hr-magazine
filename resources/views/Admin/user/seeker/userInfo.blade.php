...
<div class="content-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between border-bottom py-1">
        ...
        <div class="btn-wrapper">
            <button form="deleteJobSeeker" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-sm" style="color: #ed2708"><i class="icon-trash"></i> Delete User
            </button>
                            ...
                            <div class="card-body d-flex flex-column justify-content-around">
                                ...
                                <div class="row justify-content-between align-items-start">
                                    <div class="col-auto text-center">
                                        ...
                                        <div class="m-n5">
                                            <a href="{{asset('admin/jobSeekersCVs/'.$user->jobSeekerUser?->cv)}}" class="text-decoration-none text-black small"><small>{{$user->jobSeekerUser?->cv}}</small></a>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="col-auto form-check form-check-flat form-check-primary">
                                            <label for="active" class="form-check-label">
                                                <input type="checkbox" id="active" class="form-check-input" form="edit-user" name="active" @checked($user->active) disabled/>
                                                Active
                                            </label>
                                        </div>
                                    </div>
