          ...
          <div class="table-responsive content">
            <table class="table table-striped">
              ...
              @foreach($jobSeekers as $seeker)  
                <tr>
                  <td>
                    <a href="{{route('admin.jobSeekers.show', $seeker->userjobseeker->slug)}}" class="link-primary text-decoration-none">{{$seeker->userjobseeker->firstName}} {{$seeker->userjobseeker->secondName}}</a>
                  </td>
                  <td class="py-1">
                    <a href="mailto:someone@example.com">{{$seeker->userjobseeker->email}}</a>
                  </td>
                  <td>
                    <a href="tel:+4733378901">{{$seeker->userjobseeker->mobile}}</a>
                  </td>
