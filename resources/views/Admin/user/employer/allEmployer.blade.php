                            ...
                            <div class="col-4 col-lg-2 d-flex flex-column justify-content-center">
                                <div class="row">
                                    <label for="active" class="form-check-label">
                                        <input type="checkbox" id="active" class="form-check-input" value="active"
                                               name="active">
                                        Active
                                    </label>
                                </div>
                                <div class="row">
                                    <label for="blocked" class="form-check-label">
                                        <input type="checkbox" id="blocked" class="form-check-input" value="blocked"
                                               name="blocked">
                                        Blocked
                                    </label>
                                </div>
                            ...
                            <table id="example" class="table table-striped" style="width: 100%">
                                ...
                                @foreach ($employer as $employ)
                                    <tr>
                                        <td class="py-1">
                                            <img
                                                src="{{ asset('assets/images/users/'.$employ->image)}}"
                                                alt="image"
                                                class="img-fluid rounded-circle"
                                            />
                                        </td>
                                        <td>
                                            <a href="{{route('admin.employers.show',[$employ->slug])}}"
                                               class="link-primary text-decoration-none">{{$employ->firstName}} {{$employ->secondName}}</a>
                                        </td>
                                        <td>{{$employ->email}}</td>
                                        <td>{{$employ->mobile}}</td>
