                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-6 position-relative" id="change-pic">
                                            ...
                                            >
                                            <img src="{{asset('assets/images/articles/'.$article->image)}}" class="img-fluid"
                                                 id="article_pic">
                                        ...
                                        <div class="col-lg-8 align-self-start pt-4">
                                            ...
                                            <div class="row py-1" id="author-section">
                                                <hr class="w-75 mx-3">
                                            ...
                                            <div class="row py-1" id="source-section">
                                                <hr class="w-75 mx-3">
                                                <p class="card-text fw-bold lh-1">Source Name<i class="mdi mdi-link-variant-minus"></i></p>
                                                <p class="card-text lh-1">
                                            ...
                                            <div class="row py-1" id="youtube-section">
                                                <hr class="w-75 mx-3">
                                                <p class="card-text fw-bold lh-1">
                                            ...
                                            <div class="row py-1">
                                                ...
                                                <div
                                                    class="form-check form-check-flat form-check-primary col-lg-4">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                                <div class="card-body">
                                        ...
                                        <p class="card-text fw-bold">Content</p>
                                        <p class="card-text">
                        <textarea name="content" form="edit-article"
                                  class="form-control p-0 pe-5 border-0 bg-transparent" style="height: 30rem; line-height: 1.6"
