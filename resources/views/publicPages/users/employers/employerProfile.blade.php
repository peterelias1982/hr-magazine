                        ...
                        <div class="col-xl-3 col-md-3 col-sm-3">
                            @auth
                                @can('isOwner', ['userId' => $user?->id])
                                    <button class="bg-light border-0 text-danger fw-semibold fs-2 me-5 my-3 float-end"
                                            onclick="redirectToEdit('@isset($user) {{ route('employers.edit', $user->slug) }} @endisset')">
                                        Edit
                                    </button>
                                    <script>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-md-9 col-sm-9">
                            ...
                            <p class="px-3 pb-2 text-muted">
                                @isset($user)
                                    {{$user->employerUser->about_company}}
                                @endisset
                            </p>
                        </div>
