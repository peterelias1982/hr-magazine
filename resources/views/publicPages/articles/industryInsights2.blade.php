    ...
    <div class="container-fluid">
        <div class="row bg-light px-md-5 px-1 py-4">
            ...
            <div class="col">
                ...
                >
                    <img
                        src="{{asset('publicPages/images/industryTrends.jpg')}}"
                ...
                <div class="col-md-8 py-3 px-4 sliderWrapper">
                    <div class="card mb-3 bg-dark border-0 slide_custom">
                        <div class="row g-0 align-items-center justify-content-center">
                            ...
                            >
                                <img
                                    src="{{asset('publicPages/images/industryTrends2.jpg')}}"
        ...
        <div class="row bg-light">
            ...
            <div class="col-12">
                <div class="row pb-5">
                    <div class="col-lg-6">
                        <div
                            class="card bg-dark text-white mx-md-5 mx-1 mt-5 overflow-hidden position-relative"
                            style="
                  ...
                  "
                        >
                            <img
                                src="{{asset('publicPages/images/industryTrends3.jpg')}}"
                                class="card-img image-center"
                                alt="..."
                            />
                            <div
