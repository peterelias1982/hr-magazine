        ...
        <div class="row bg-light px-md-5 px-1 py-4">
            ...
            <div class="col">
                <div class="card bg-dark text-white landing-img mx-lg-5 mx-md-3 mx-1"
                    ...
                    <img src="{{asset('assets/images/articles/'. (isset($trends[0])? $trends[0]->image:''))}}"
                         class="card-img image-center" alt="{{isset($trends[0])? $trends[0]->title: ''}}"/>
            ...
            <div class="col-12">
                <div class="row pb-5">
                    @foreach($insights as $article)
                        <div class="col-lg-6">
                            <div class="card bg-dark text-white mx-md-5 mx-1 mt-5 overflow-hidden position-relative"
                                 style="
