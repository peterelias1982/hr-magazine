                    ...
                    >
                        ...
                        ></span>
                                ...
                                <div class="row justify-content-center py-3">
                                    ...
                                    >
                                        <h2 class="fw-bolder">HRs Workplace Culture1</h2>
                        ...
                        ></span>
                                ...
                                <div class="row justify-content-center py-3">
                                    ...
                                    <div
                                        class="col-xl-10 col-md-9  d-flex flex-column"
                                    >
                                        <h2 class="fw-bolder">HRs Workplace Culture2</h2>
                                        <h3 class="fw-bold">Thursday Dec 12 2023</h3>
                                        <h4 class="fw-bold">Amged S. El-Hawrani</h4>
                                        <p class="fs-4 fw-semibold">
                                            Lorem ipsum dolor sit amet consectetur. Pellentesque
                        ...
                        ></span>
                                ...
                                <div class="row justify-content-center py-3">
                                    ...
                                    <div
                                        class="col-xl-10 col-md-9  d-flex flex-column"
                                    >
                                        <h2 class="fw-bolder">HRs Workplace Culture3</h2>
                                        <h3 class="fw-bold">Thursday Dec 12 2023</h3>
                    ...
                    >
                        ...
                        ></span>
                                ...
                                <div class="row justify-content-center py-3">
                                    ...
                                    >
                                        <h2 class="fw-bolder">
                                            HRs Diversity, Equity, and Inclusion (DEI)
                                        </h2>
                                        <h3 class="fw-bold">Thursday Dec 12 2023</h3>
                                        <h4 class="fw-bold">Nadia S. El-Hawrani</h4>
                                        <p class="fs-4 fw-semibold">
                    ...
                    >
                        ...
                        ></span>
                                ...
                                <div class="row justify-content-center py-3">
                                    ...
                                    >
                                        <h2 class="fw-bolder">
                                            HRs Mental Health in the Workplace
                                        </h2>
                                        <h3 class="fw-bold">Thursday Dec 12 2023</h3>
                                        <h4 class="fw-bold">Nadia S. El-Hawrani</h4>
                                        <p class="fs-4 fw-semibold">
                            ...
                            <div class="carousel-item" data-bs-interval="3000">
                                ...
                                >
                                    <img
                                        src="{{asset('publicPages/images/workplaceCulture-wellBeing-slide-6.jpg')}}"
                                        class="d-block image-center"
                                        alt="slide-img2"
                                    />
                                    <button
                        ...
                        ></span>
                            ...
                            <div class="carousel-item" data-bs-interval="7000">
                                ...
                                >
                                    <img
                                        src="{{asset('publicPages/images/workplaceCulture-wellBeing-slide-7.jpg')}}"
                                        class="d-block image-center"
                                        alt="slide-img3"
                                    />
                                    <button
                        ...
                        ></span>
                            ...
                            <div class="carousel-item" data-bs-interval="9000">
                                ...
                                >
                                    <img
                                        src="{{asset('publicPages/images/workplaceCulture-wellBeing-slide-8.jpg')}}"
                                        class="d-block image-center"
                                        alt="slide-img4"
                                    />
                                    <button
