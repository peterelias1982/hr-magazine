    ...
    <div class="row bg-light px-md-5 px-1 py-4">
        ...
        <div class="col">
            <div class="card bg-dark text-white landing-img mx-lg-5 mx-md-3 mx-1" style="border: 1px solid hsla(0, 2%, 68%, 0.4); height: 695px">
                <img src="{{asset('assets/images/articles/'. (isset($perspectives[0])? $perspectives[0]->image:''))}}" class="card-img image-center" alt="{{isset($perspectives[0])? $perspectives[0]->title: ''}}" />
                ...
                <div class="card mb-3 bg-dark border-0 slide_custom">
                    <div class="row g-0 align-items-center justify-content-center">
                        <div class="col-md-3 overflow-hidden position-relative rounded-fill" style="aspect-ratio: 1.1">
                            <img src="{{asset('assets/images/articles/'.$article->image)}}" class="img-fluid image-center rounded-circle" alt="{{$article->title}}" />
                        </div>
                        <div class="col-md-7">
                            <div class="card-body">
...
<div class="row bg-dark">
    ...
    <div class="col-12">
        <div class="row pb-5">
            ...
            <div class="col-lg-6">
                <div class="card bg-dark text-white mx-md-5 mx-1 mt-5 rounded-circle overflow-hidden position-relative" style="border: 5px solid #ffffff">
                    <div class="overflow-hidden position-relative" style="max-height: 600px; aspect-ratio: 1">
                    <img src="{{asset('assets/images/articles/'.$article->image)}}" class="image-center" style="aspect-ratio: 1" alt="{{$article->title}}" />
                    </div>
                    <div class="gradient position-absolute start-0 top-0" style="width: 100%; height: 100%"></div>
                    <div class="card-img-overlay overflow-auto" style="top: 35%">
                        ...
                        <p class="card-text fs-14px text-border">
                            {{Str::limit($article->content, 220)}}
                            <a href="{{ route('articleSingle', ['category' => $article->articleCategory->slug, 'article' => $article->slug]) }}" class="text-decoration-none text-white">Read more</a>
                        </p>
                    </div>
                </div>
            </div>
