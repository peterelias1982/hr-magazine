    ...
    <div class="container-fluid">
        ...
        <div class="row slide_group overflow-hidden bg-dark">
            <div class="row flex-nowrap slideWrapper overflow-hidden">
                ...
                <div class="sliderWrapper col-md-8 py-3 px-4">
                    <div class="card mb-3 bg-dark border-0 slide_custom">
                        <div class="row g-0 align-items-center justify-content-center">
                            ...
                            >
                                <div class="ratio ratio-16x9">
                                    <!-- Default Image -->
                                    <img
                                        src="{{asset('publicPages/images/sm-vedio-img-2.svg')}}"
                                        alt="Default Video Image"
                                        class="embed-cover"
                                    />
                                    <!-- Iframe for Video -->
                        ...
                        <div class="row g-0 align-items-center justify-content-center">
                            ...
                            >
                                <div class="ratio ratio-16x9">
                                    <!-- Default Image -->
                                    <img
                                        src="{{asset('publicPages/images/exp-int3.jpg')}}"
                                        alt="Default Video Image"
                                        class="embed-cover"
                                    />
                                    <!-- Iframe for Video -->
                        ...
                        <div class="row g-0 align-items-center justify-content-center">
                            ...
                            >
                                <div class="ratio ratio-16x9">
                                    <!-- Default Image -->
                                    <img
                                        src="{{asset('publicPages/images/exp-int4.jpg')}}"
                                        alt="Default Video Image"
                                        class="embed-cover"
                                    />
                                    <!-- Iframe for Video -->
