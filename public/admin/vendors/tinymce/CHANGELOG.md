...
- Fixed handling of mixed-case icon identifiers (names) for Users. #TINY-3854
...
- Fixed a bug where setProgressState wouldn't automatically close floating Users like menus. #TINY-2896
...
- Fixed a bug that was causing incorrect viewport calculations for fixed position Users. #TINY-1897
...
- Fixed bug where some Users could be inserted into the toolbar even if they where not registered.
...
- Fixed bug where the visualblocks plugin would render borders round internal Users.
...
- Fixed so all Users uses touch events to improve mobile device support.
